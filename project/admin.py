...
class ReportedProjectsAdmin(admin.ModelAdmin):
    readonly_fields = ('date',)


admin.site.register(ReportedProjects, ReportedProjectsAdmin)
...
admin.site.register(ReportedComments, ReportedCommentsAdmin)
