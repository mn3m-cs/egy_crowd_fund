...
urlpatterns = [
    ...
    path('report_comment/<c_pk>/<project>/',
         views.report_comment, name='report_comment'),
    path('delete_project/<int:pk>/',
         views.DeleteProjectView.as_view(), name='cancel'),
    path('projects/', views.AllProjects.as_view(), name='projects_list'),
    # REST views
    path('filter_tag_or_title/',
         rest_views.TagTitleFilter.as_view(), name='tagsfilter'),
    path('filter_by_category/',
         rest_views.CategoryFilter.as_view(), name='cats_filter'),
]
